...
export default function StudioPage() {
  return (
    <PageLayout showTransition={false}>
      ...
      <section className="px-6 md:px-10 py-20 border-y border-border bg-ink/40">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-12 gap-6 md:gap-8">
          {[
      ...
      <section className="px-6 md:px-10 py-24 bg-ink/40 border-y border-border overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex overflow-hidden pb-8">
          <div className="flex gap-6 marquee w-max hover:[animation-play-state:paused]">
            {[...team, ...team, ...team].map((m, i) => (
              <div
                key={m.name + i}
                className="shrink-0 w-[65vw] sm:w-[45vw] md:w-[30vw] lg:w-[22vw]"
              >
      ...
      <section className="px-6 md:px-10 py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] py-4">
